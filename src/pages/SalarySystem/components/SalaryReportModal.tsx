          ...
          <table className="report-table">
            <thead>
              <tr>
                ...
                <th rowSpan={2} style={{ width: '10%' }}>เงิน IC</th>
                <th colSpan={2}>เคสสตอรี่</th>
                <th rowSpan={2} style={{ width: '10%' }}>เงิน OC</th>
                <th colSpan={4}>สวัสดิการ (กาชา)</th>
                <th rowSpan={2} style={{ width: '8%' }}>เหรียญ</th>
              </tr>
              <tr>
